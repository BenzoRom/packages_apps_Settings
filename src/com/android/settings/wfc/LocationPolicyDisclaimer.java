...
/**
 * Disclaimer item class for displaying location privacy policy UI on {@link DisclaimerActivity}.
 */
class LocationPolicyDisclaimer extends DisclaimerItem {
    ...
    LocationPolicyDisclaimer(Context context, int phoneId) {
    ...
    protected int getMessageId() {
        return R.string.wfc_disclaimer_location_desc_txt;
    }
